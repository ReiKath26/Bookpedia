        ...
        <div class="col-9">
            <div class="card p-3 fw-bolder">
                <div class="d-flex justify-content-between">
                    <p >Order Status</p>
                    <p class=" <?php if($head->status == "paid"): ?>
                        text-success
                        <?php else: ?>
                        text-danger
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\@BINUS\Semester 5\WebProg\bp\resources\views/historyDetail.blade.php ENDPATH**/ ?>