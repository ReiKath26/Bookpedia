	...
	<div class="card-body">
		<div class="account-settings">
			<div class="user-profile">
				...
				<button type="button" id="submit" name="submit" class="btn btn-secondary mt-3">History Order</button>
			</div>
		</div>
	</div>
</div>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\kenis\Documents\BINUS\Web Programming\Bookpediaa\resources\views/profile.blade.php ENDPATH**/ ?>