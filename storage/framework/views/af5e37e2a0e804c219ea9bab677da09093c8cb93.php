    ...
    <div class="card ml-auto mr-auto" style="width: 750px; overflow:auto">
        ...
        <div class="card-body">
            ...
            <h3>Register Account</h3>
                <?php echo csrf_field(); ?>
                <?php if($errors->any()): ?>
                    <?php echo implode('', $errors->all('<div class="error-message"><b>:message</b></div>')); ?>
...
</html><?php /**PATH C:\Users\kenis\Documents\BINUS\Web Programming\Bokpedia_book\resources\views/register.blade.php ENDPATH**/ ?>