        ...
        <div class="col col-12">
            <div class="card">
                  ...
                  <table class="table table-stripped">
                    ...
                    <?php if($thisShippingAddress): ?>
                      <tr>
                        ...
                        <td>
                          <a href="<?php echo e(route('shippingaddress.index')); ?>" class="btn btn-success btn-sm">
                            Change address
                          </a>
                        </td>
                      </tr>
              ...
              <div class="card-footer">
                <a href="<?php echo e(route('shippingaddress.index')); ?>" class="btn btn-sm btn-primary">
                  Add new address
                </a>
              </div>
            </div>
              ...
              <table class="table table-stripped">
                ...
                <?php if($thisShipping): ?>
                  <tr>
                    ...
                    <td>
                      <a href="<?php echo e(route('shipping.index')); ?>" class="btn btn-success btn-sm">
                        Change Method
                      </a>
                    </td>
                  </tr>
              ...
              <table class="table table-stripped">
                ...
                <?php if($thisPayment): ?>
                  <tr>
                    ...
                    <td>
                      <a href="<?php echo e(route('payment.index')); ?>" class="btn btn-success btn-sm">
                        Change Payment
                      </a>
                    </td>
                  </tr>
...
<?php echo $__env->make('transact', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\kenis\Documents\BINUS\Web Programming\Bookpediaaa\resources\views/checkout.blade.php ENDPATH**/ ?>